  ...
  return (
    <div style={{ maxWidth: "1200px" }} className="mt-5 container ">
      ...
      <div className="row justify-content-center ">
        <div
          data-aos="fade-up"
          className="col-6 col-sm-11 col-md-6 mx-auto border border-primary rounded-4 border-hover text-center p-3 g-3"
        >
        ...
        >
          ...
          <div className="w-75 mx-auto">
            I have a strong proficiency in creating custom designs that are not
            only visually captivating but also fully responsive, ensuring a
